...
void fire(int grnLow) {
  for (int grnPx = grnHigh; grnPx > grnLow; grnPx--) {
    ...
    strip.setPixelColor(4, redPx-180, darkGrn, 0);
    strip.setPixelColor(5, redPx-180, darkGrn, 0);
    strip.setPixelColor(6, redPx-120, grnPx-50, bluePx-5);
    strip.setPixelColor(7, redPx-60, grnPx-35, bluePx-2);
...
void on(int f) {
  ...
  int grnPx = grnHigh - 6;
    ...
    strip.setPixelColor(2, redPx-120, grnPx-50, bluePx-5);
    strip.setPixelColor(3, redPx-60, grnPx-35, bluePx-2);
    strip.setPixelColor(4, redPx-180, grnPx-70, 0);
    strip.setPixelColor(5, redPx-180, grnPx-70, 0);
    strip.setPixelColor(6, redPx-120, grnPx-50, bluePx-5);
    strip.setPixelColor(7, redPx-60, grnPx-35, bluePx-2);
